...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'apiKey.dart' as _i5;
import 'greetings/greeting.dart' as _i6;
import 'transaction.dart' as _i7;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.Trans) {
      return _i7.Trans.fromJson(data) as T;
    }
    if (t == _i8.User) {
    ...
    if (t == _i1.getType<_i7.Trans?>()) {
      return (data != null ? _i7.Trans.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Trans') {
      return deserialize<_i7.Trans>(data['data']);
    }
